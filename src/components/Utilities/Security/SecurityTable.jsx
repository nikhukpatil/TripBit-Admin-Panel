...
const SecurityTable = () => {
  const [data, setData] = useState([
    { Role: 'Admin', Description: 'Full access to all security settings' },
    { Role: 'User', Description: 'Limited access to personal settings' },
    { Role: 'Guest', Description: 'Restricted access to public areas only' },
    { Role: 'Supervisor', Description: 'Access to supervise and manage user activities' }
  ]);
  ...
  const roles = {
    Admin: 'Full access to all security settings',
    User: 'Limited access to personal settings',
    Guest: 'Restricted access to public areas only',
    Supervisor: 'Access to supervise and manage user activities'
  };
      ...
      {isFormOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-8 rounded shadow-lg w-96">
            <h2 className="text-xl mb-4">Add New Security Role</h2>
